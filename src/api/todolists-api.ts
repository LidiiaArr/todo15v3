...
//при запросе на сервер возвращается большой объект одним из свойств которого является result code: number
//result code говорит есть ли какая-нибудь ошибка 0-все ок любое другое ошибка
